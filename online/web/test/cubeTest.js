...
function writeCsv(t)
{
    csvContent+="1,1000,"+t+","+cube.position.x+","+cube.position.y+","+cube.position.z+","+cube.quaternion.x+","+cube.quaternion.y+","+cube.quaternion.z+","+cube.quaternion.w+"\n";
    csvContent+="2,1000,"+t+","+cube2.position.x+","+cube2.position.y+","+cube2.position.z+","+cube2.quaternion.x+","+cube2.quaternion.y+","+cube2.quaternion.z+","+cube2.quaternion.w+"\n";
}
